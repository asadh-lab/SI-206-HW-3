# Your name: Hamza Asad
# Your student id: 45662901
# Your email: asadh@umich.edu
# List who you have worked with on this homework: Angel Ranjel, William Luna, and Taejung Park
...
class Animal_Fact_Generator:
    ...
    def __str__(self):
        self.new_string=",".join(self.animal_list)
        return self.new_string




          #return(str(*self.animal_list sep = ", "))
        #  # for i in range(length(animal_list)):
            #return str(animal_list[i]+",") Doesnt print on the smae line so doesnt really work
    ...
    def random_fact(self):
        x=random.randrange(0,len(self.fact_list)-1)
        self.fact_history_list.append(x)
        return self.fact_list[x]+" - "+self.animal_list[x]
    ...
    def get_fact_for_animal(self,name_of_animal):
        self.name_of_animal = name_of_animal
        for i in range(len(self.animal_list)):
            if name_of_animal == self.animal_list[i]:
                return self.fact_list[i]
        return "Sorry! I do not have any facts for {name_of_animal}"

            
            
            #if animal==name_of_animal:
                #return self.fact_list[animal]
            # return "Sorry! I do not have any facts for" + "" name_of_animal"
    ...
    def print_history(self):
        for i in self.fact_history_list:
            print(f"[{i}]"+self.fact_list[i]+"-"+self.animal_list[i])
